    ...
    <div className="min-h-screen bg-primary-black flex items-center justify-center p-4">
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <h2 className="text-3xl font-bold text-soft-white mb-2">C.T.B.A</h2>
          <p className="text-gray-400">Professional cryptocurrency trading platform</p>
        </div>
        ...
        <div className="bg-dark-gray rounded-xl shadow-lg p-8 border border-medium-gray">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center justify-between">
              ...
              <a href="#" className="text-sm text-metallic-gold hover:text-gold-hover">
                Forgot password?
              </a>
            </div>
