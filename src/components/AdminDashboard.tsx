...
import { useWithdrawalRequests, type WithdrawalRequest } from '../hooks/useWithdrawalRequests';
...
const adminMenuItems = [
  ...
  { icon: CreditCard, label: 'Withdrawals', id: 'withdrawals' },
                        ...
                        {request.status === 'pending' ? (
                          <div className="flex items-center space-x-2">
                            <button
                              ...
                              className="bg-metallic-gold text-primary-black px-3 py-1 rounded text-xs font-medium hover:bg-gold-hover transition-colors disabled:opacity-50"
                            >
                            ...
                            <button
                              ...
                              disabled={processingId === request.id}
                              className="bg-red-500 text-white px-3 py-1 rounded text-xs font-medium hover:bg-red-600 transition-colors disabled:opacity-50"
                            >
                              Mark Failed
                            </button>
                          </div>
