...
const mockUsers = [
  { id: '1', name: 'John Doe', email: 'john@example.com', wallet: '1A1zP1...92P', status: 'Active', balance: '₦2,450,000' },
  { id: '2', name: 'Jane Smith', email: 'jane@example.com', wallet: '3FxY9a...8kL', status: 'Active', balance: '₦1,200,000' },
  { id: '3', name: 'Mike Johnson', email: 'mike@example.com', wallet: '1BvBM...7qT', status: 'Inactive', balance: '₦850,000' },
];

const mockTransactions = [
  { id: '1', user: 'John Doe', coin: 'BTC', type: 'Buy', amount: '₦500,000', status: 'Successful', date: '2024-01-15' },
  { id: '2', user: 'Jane Smith', coin: 'ETH', type: 'Sell', amount: '₦200,000', status: 'Pending', date: '2024-01-15' },
  { id: '3', user: 'Mike Johnson', coin: 'USDT', type: 'Buy', amount: '₦100,000', status: 'Failed', date: '2024-01-14' },
];
...
export default function AdminDashboard({ user, onLogout }: AdminDashboardProps) {
      ...
      <div className="flex items-center justify-between px-6 py-4">
        ...
        <div className="flex items-center space-x-4">
          <div className="flex items-center space-x-2 px-3 py-1 bg-electric-blue bg-opacity-20 rounded-full">
            ...
            <span className="text-sm font-medium text-electric-blue">System Online</span>
          </div>
    ...
    <div className="space-y-8">
        ...
        <div className="bg-dark-gray p-6 rounded-xl border border-medium-gray">
          ...
          <div className="space-y-3">
            ...
            <div className="w-full bg-medium-gray rounded-full h-2">
              <div className="bg-metallic-gold h-2 rounded-full" style={{ width: '75%' }}></div>
            </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-dark-gray p-6 rounded-xl border border-medium-gray">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-gray-400">Platform Balance</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-dark-gray p-6 rounded-xl border border-medium-gray">
          <h3 className="text-lg font-semibold text-soft-white mb-4">Transaction Trends</h3>
        ...
        <div className="bg-dark-gray p-6 rounded-xl border border-medium-gray">
          <h3 className="text-lg font-semibold text-soft-white mb-4">Crypto Distribution</h3>
          <div className="h-64 bg-medium-gray rounded-lg flex items-center justify-center border border-light-gray">
          ...
          <table className="w-full">
            ...
            <tbody className="divide-y divide-medium-gray">
              {mockTransactions.map((tx) => (
                <tr key={tx.id}>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-soft-white">{tx.user}</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-soft-white">{tx.coin}</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-soft-white">{tx.type}</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-soft-white">{tx.amount}</td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span className={`px-2 py-1 text-xs font-medium rounded-full ${
                      tx.status === 'Successful' ? 'bg-metallic-gold bg-opacity-20 text-metallic-gold' :
            ...
            <tbody className="divide-y divide-medium-gray">
              {mockUsers.map((user) => (
                <tr key={user.id}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-soft-white">{user.wallet}</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-soft-white">{user.balance}</td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span className={`px-2 py-1 text-xs font-medium rounded-full ${
                      user.status === 'Active' ? 'bg-metallic-gold bg-opacity-20 text-metallic-gold' : 'bg-red-500 bg-opacity-20 text-red-400'
                    }`}>
                      {user.status}
                    </span>
                  </td>
  ...
  const renderTransactions = () => (
    <div className="space-y-8">
      <div>
        <h1 className="text-2xl font-bold text-soft-white mb-2">All Transactions</h1>
        <p className="text-gray-400">Monitor all platform transactions</p>
      </div>
      <div className="text-center py-12"><p className="text-gray-400">Transactions management coming soon</p></div>
    </div>
  );
  ...
  const renderWallets = () => (
    <div className="space-y-8">
      ...
      <div className="text-center py-12"><p className="text-gray-400">Wallet management coming soon</p></div>
    </div>
  );
  ...
  const renderSettings = () => (
    <div className="space-y-8">
      <div>
        <h1 className="text-2xl font-bold text-soft-white mb-2">Platform Settings</h1>
